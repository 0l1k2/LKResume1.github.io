...
\documentclass{resume}
\usepackage{zh_CN-Adobefonts_external} % 简体中文支持（使用外部字体）
\usepackage{linespacing_fix} % 调整章节前后额外空白
\usepackage{cite}
...
% 格式: {电话}{邮箱}{职位}{GitHub或主页}
\contactInfo{133 6760 6637}{studylinux781@gmail.com, 2504095682@qq.com}{IT小白}{GitHub @0l1k2}
...
\section{教育背景}
\datedsubsection{\textbf{重庆邮电大学}, 软件工程 (本科)}{2022.9 -- 2026.6} \\
